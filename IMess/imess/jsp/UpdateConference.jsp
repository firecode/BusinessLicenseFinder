...
<HEAD>
  <TITLE>Meeting Template update Form</TITLE>
...
style="color: rgb(51, 102, 255);">Conference Update Form for Meeting Organizer<br>
...
<FORM name="UPDATEMEETINGTEMPLATE" METHOD=POST ACTION="/imess/IMessController">
    <INPUT TYPE="hidden" NAME="Form" VALUE="UPDATEMEETINGTEMPLATE">
    <CENTER>
  ...
  <table width="90%" border="1" bordercolor="#000000" bgcolor="#ffffcc" >
    <tr> 
      ...
      (Robotics Conference 2004) </font> 
        <input type="text" name="mName" value="<%=mTemplate.getName() %>" size="34" readonly style='background-color:#808080;'>
        </strong></font></td>
      <td width="22%"><font face="Arial, Helvetica, sans-serif">Duration: <font size="1"> 
      (07/24/2004 - 07/29/2004)</font> &nbsp; &nbsp; &nbsp; &nbsp;
        <input type="text" name="mDuration" value="<%=mTemplate.getDateSpan() %>" size="34" readonly style='background-color:#808080;'>
        </font></td> 
</tr>
<tr>
      <td width="24%"><font face="Arial, Helvetica, sans-serif">Location: <font size="1"> 
      (Birmingham)</font> &nbsp; &nbsp; &nbsp; &nbsp;

        <input type="text" name="mLocation" value="<%=mTemplate.getLocation() %>" size="34">
        </font></td>
      <td width="25%"><font face="Arial, Helvetica, sans-serif">Modified Date: <font size="1"> 
      (07/21/2004)</font> &nbsp; &nbsp; &nbsp; &nbsp;
        <input type="text" name="mModified" value="<%=mTemplate.getModified() %>" size="34">
        </font></td>
    </tr>
  </table>
...
<HR>
  <table width="80%" border="1" bordercolor="#000000" bgcolor="#ffffcc" >
    ...
    <tr> 
     ...
     <%} 
      ...
      <td width="31%"> 
        <div align="center"> 
          <input type="text" name="<%=secondFld + i %>" value="<%=mtFields.getName()%>" size="35"  readonly style="background-color:#808080;">
        </div>
      </td>
      <td width="25%"> 
        <div align="center"> 
          <input type="text" name="<%=thirdFld + i %>" value="<%=mtFields.getValue() %>" size="32" readonly style="background-color:#808080;">
        </div>
      </td>
      <td width="30%"> 
        <div align="center"> 
        <input type="text" name="<%=fourthFld + i %>" value="<%=mtFields.getType() %>" size="32" readonly style="background-color:#808080;">
        </div>
      </td>
      <%};%>
    </tr>
  ...
  <table width="90%" border="1" bordercolor="#000000" bgcolor="#ffffcc" >
    <tr> 
      ...
      <td width="13%"> 
        <div align="center">Duration (Date)</div>
	  <div align="center"><font size="1">(07/24/2004)</font></div>
      </td>
      <td width="12%"> 
        <div align="center">Duration (Time)</div>
    ...
    <tr> 
      ...
      <td width="26%"> 
        <div align="center">
          <input type="text" name="<%=field2  + j %>" value="<%=stFields.getName()%>" size="35" readonly style="background-color:#808080;">
        </div>
      </td>
      <td width="13%"> 
        <div align="center">
          <input type="text" name="<%=field3  + j %>" value="<%=stFields.getDateSpan()%>" size="20" readonly style="background-color:#808080;">
        </div>
      </td>
      <td width="12%"> 
        <div align="center">
          <input type="text" name="<%=field4  + j %>" value="<%=stFields.getTimeSpan()%>" size="20" readonly style="background-color:#808080;">
        </div>
      </td>
      <td width="11%"> 
        <div align="center">
          <input type="text" name="<%=field5  + j %>" value="<%=stFields.getRoom()%>" size="15" readonly style="background-color:#808080;">
        </div>
      </td>
      <td width="10%"> 
        <div align="center">
          <input type="text" name="<%=field6  + j %>" value="<%=stFields.getConvener()%>" size="16" readonly style="background-color:#808080;">
        </div>
      </td>
      <%}%>
    </tr>
